...
public class PasswordChange {
	...
	public PasswordChange(long id, String email, String verificationCode, LocalDateTime timeOfRequest) {
		super();
		this.id = id;
		this.email = email;
	...
	public PasswordChange(String email, String verificationCode, LocalDateTime timeOfRequest) {
		super();
		this.email = email;
		this.verificationCode = verificationCode;
		this.timeOfRequest = timeOfRequest;
